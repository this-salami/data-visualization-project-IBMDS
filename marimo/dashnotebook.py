# created by "python -m marimo convert DV0101EN-Final-Assign-Part-2-Questions.py -o marimo/dashnotebook.py"
# (direct conversion, python (dash) to marimo notebook)
...
def _():
    ...
    app.layout = html.Div([
        ...
        html.Div([#TASK 2.3: Add a div for output display
        html.Div(
            id = 'output-container', 
